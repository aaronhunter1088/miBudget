...
//
//            resp.sendRedirect(request.getContextPath() + "/static/index.html"); // No logged-in user found, so redirect to login page.
//        } else {
...
//        }
    ...
    private boolean needsAuthentication(String url) {
        List<String> validNonAuthenticationUrls =
                List.of("/miBudget/", "/miBudget/static/index.html",
